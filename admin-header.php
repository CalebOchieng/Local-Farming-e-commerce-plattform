        ...
        <div class="nav-left">
            <div class="nav-logo">
                ...
                <?php if(isset($_SESSION['admin_id'])) {?>
                    <?php echo "<h5><a href='dashboard.php'>Local Farming</a> Trader</h5>"; ?>
                <?php } else {?>
                    <?php echo "<h5><a href='#'>Local Farming</a> Admin</h5>"; ?>
                <?php } ?>
        ...
        <div class="nav-items">
            <ul>
                <div class="common-items">
                    <?php if(isset($_SESSION['admin_id'])) { ?>
                        <?php echo " <li><a href='items.php'>Products</a></li>" ?>
                        <?php echo " <li><a href='sales.php'>Sales</a></li>" ?>
                    <?php }?>
                </div>
